package com.txt.kafka.consumer;
...
import com.txt.base.consumer.CountryPopulation;
import com.txt.base.consumer.CountryPopulationConsumer;
...
public class CountryPopulationConsumerUnitTest {
    ...
    void whenStartingByAssigningTopicPartition_thenExpectUpdatesAreConsumedCorrectly() {
        // GIVEN
        consumer.schedulePollTask(() -> consumer.addRecord(record(TOPIC, PARTITION, "VN", 99_950_000)));
        ...
        AssertionsForClassTypes.assertThat(consumer.closed()).isTrue();
    }
    ...
    void whenStartingBySubscribingToTopic_thenExpectUpdatesAreConsumedCorrectly() {
        ...
        consumer.schedulePollTask(() -> {
            ...
            consumer.addRecord(record(TOPIC, PARTITION, "VN", 99_950_000));
        });
        consumer.schedulePollTask(() -> countryPopulationConsumer.stop());
