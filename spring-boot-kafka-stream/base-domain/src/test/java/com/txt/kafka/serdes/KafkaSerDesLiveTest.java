...
import com.txt.base.dto.MessageDto;
...
public class KafkaSerDesLiveTest {
    ...
    private static KafkaProducer<String, MessageDto> createKafkaProducer() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, "com.txt.base.serdes.CustomSerializer");
    ...
    private static KafkaConsumer<String, MessageDto> createKafkaConsumer() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.txt.base.serdes.CustomDeserializer");
    ...
    public void givenKafkaClientShouldSerializeAndDeserialize() throws InterruptedException {
        ...
        Assertions.assertEquals(msgProd, msgCons.get());
    }
