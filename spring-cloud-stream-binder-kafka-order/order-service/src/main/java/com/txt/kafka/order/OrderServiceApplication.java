package com.txt.kafka.order;

import com.txt.kafka.order.model.Order;
...
import com.txt.kafka.order.model.OrderType;
...
//                        .setHeader(KafkaHeaders.MESSAGE_KEY, Objects.requireNonNull(buyOrders.get(new Random().nextInt(buyOrders.size()))).getId())
                        .build();
