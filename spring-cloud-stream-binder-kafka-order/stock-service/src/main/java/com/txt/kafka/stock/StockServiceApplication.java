package com.txt.kafka.stock;

import com.txt.kafka.stock.model.Order;
import com.txt.kafka.stock.model.Transaction;
import com.txt.kafka.stock.model.TransactionTotal;
import com.txt.kafka.stock.service.OrderService;
...
import com.txt.kafka.stock.model.TransactionTotalWithProduct;
...
//            log.info("Executed: orderBuy={}, orderSell={}", orderBuy.getId(), orderSell.getId());
            boolean allowed = orderService.performUpdate(orderBuy.getId(), orderSell.getId(), count);
            if (!allowed)
                return null;
            else
